            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-20">
              ...
              >
                ...
                <motion.h1
                  ...
                  className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-slate-100 leading-tight"
                >
                  Hi, I'm{" "}
                ...
                <motion.div
                  ...
                  className="relative bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-950 dark:to-slate-900 p-4 sm:p-6 rounded-xl border-2 border-gray-300 dark:border-slate-700 overflow-hidden"
                >
                  {/* Terminal-style header */}
                  <div className="flex items-center gap-2 mb-3 sm:mb-4 pb-2 sm:pb-3 border-b border-slate-700">
                  ...
                  <div className="font-mono text-xs sm:text-sm leading-relaxed">
                    ...
                    <div className="ml-2 sm:ml-4 space-y-1 text-slate-300 dark:text-slate-200">
                ...
                >
                  <motion.a
                    ...
                    className="flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-5 py-2.5 sm:py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-300 border-2 border-blue-700 shadow-lg hover:shadow-xl group text-sm sm:text-base"
                  >
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.97 }}
                    transition={{ duration: 0.2 }}
                    className="flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-5 py-2.5 sm:py-3 bg-slate-800 hover:bg-slate-900 dark:bg-slate-700 dark:hover:bg-slate-600 text-white rounded-lg font-medium transition-all duration-300 border-2 border-slate-700 dark:border-slate-600 shadow-lg hover:shadow-xl group text-sm sm:text-base"
                  >
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    transition={{ duration: 0.2 }}
                    className="inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 py-2.5 sm:py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-all duration-300 border-2 border-indigo-700 shadow-lg hover:shadow-xl text-sm sm:text-base"
                  >
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span className="text-center">View Resume</span>
                  </motion.a>
                  <motion.a
                    href="#details"
                    whileHover={{ scale: 1.05, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    transition={{ duration: 0.2 }}
                    className="inline-block text-center px-4 sm:px-6 py-2.5 sm:py-3 bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700 text-gray-900 dark:text-gray-100 rounded-lg font-medium transition-all duration-300 border-2 border-gray-300 dark:border-slate-700 shadow-lg hover:shadow-xl text-sm sm:text-base"
                  >
                    View Details
                  </motion.a>
                </motion.div>
              ...
              >
                ...
                <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-80 md:h-80">
