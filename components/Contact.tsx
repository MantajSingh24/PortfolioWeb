        ...
        >
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <motion.div
              ...
              className="p-4 rounded-lg border-2 border-gray-200 dark:border-slate-700 hover:border-indigo-300 dark:hover:border-indigo-700 transition-all duration-300"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02, y: -3 }}
              transition={{ duration: 0.3 }}
              className="p-4 rounded-lg border-2 border-gray-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 flex items-center gap-3 group"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02, y: -3 }}
              transition={{ duration: 0.3 }}
              className="p-4 rounded-lg border-2 border-gray-200 dark:border-slate-700 hover:border-slate-600 dark:hover:border-slate-500 transition-all duration-300 flex items-center gap-3 group"
            >
              <svg className="w-6 h-6 text-slate-700 dark:text-slate-300 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 group-hover:text-slate-600 dark:group-hover:text-slate-400 transition-colors duration-300">
                  mANtAjsINGH0
                </p>
              </div>
            </motion.a>
          ...
          <div className="border-t-2 border-gray-200 dark:border-slate-800 pt-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              >
                ...
                <p className="text-xs text-center md:text-left text-gray-500 dark:text-gray-400 mb-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <motion.input
                    ...
                    className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-indigo-500 transition-all duration-300"
                  ...
                  <motion.textarea
                    ...
                    whileFocus={{ scale: 1.01 }}
                    transition={{ duration: 0.2 }}
                    className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 resize-y"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    transition={{ duration: 0.2 }}
                    className="w-full px-6 py-3 bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-900 dark:text-gray-100 rounded-lg font-medium transition-all duration-300 border-2 border-gray-300 dark:border-slate-600 shadow-lg hover:shadow-xl"
                  >
