        ...
        >
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <motion.div
              ...
              className="p-4 rounded-lg bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 transition-all duration-300 hover:border-indigo-500 dark:hover:border-indigo-400"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02, y: -3 }}
              transition={{ duration: 0.3 }}
              className="p-4 rounded-lg bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 transition-all duration-300 hover:border-indigo-500 dark:hover:border-indigo-400 flex items-center gap-3 group"
            >
              <svg className="w-6 h-6 text-indigo-600 dark:text-indigo-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-slate-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <motion.textarea
                    ...
                    whileFocus={{ scale: 1.01 }}
                    transition={{ duration: 0.2 }}
                    className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-400/20 focus:border-indigo-500 dark:focus:border-indigo-400 transition-all duration-300 resize-y"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    transition={{ duration: 0.2 }}
                    className="w-full px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-all duration-300 border-2 border-indigo-700 hover:border-indigo-800 shadow-lg hover:shadow-xl flex justify-center"
                  >
