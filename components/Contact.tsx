    ...
    <div className="relative overflow-hidden pt-16">
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <motion.div
          ...
          className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 border border-white/30 dark:border-gray-700/30 shadow-2xl"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div
              className="p-4 rounded-lg bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm border border-white/30 dark:border-gray-700/30 transition-all duration-200 hover:border-yellow-100/80 dark:hover:border-purple-500/60"
            >
              ...
              <a
                ...
                className="text-yellow-100/90 dark:text-purple-400 hover:text-yellow-50 dark:hover:text-purple-300 transition-colors duration-300"
              >
            ...
            <a
              ...
              className="p-4 rounded-lg bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm border border-white/30 dark:border-gray-700/30 transition-all duration-200 hover:border-yellow-100/80 dark:hover:border-purple-500/60 flex items-center gap-3 group"
            >
              <svg className="w-6 h-6 text-yellow-100/90 dark:text-purple-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-slate-100 group-hover:text-yellow-100/90 dark:group-hover:text-purple-400 transition-colors duration-300">
                  ...
                  <div className="relative w-full aspect-square max-w-md mx-auto">
                    <div className="relative w-full h-full rounded-2xl p-8 flex flex-col items-center justify-center shadow-xl overflow-hidden bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/30 dark:border-gray-700/30">
                      <div className="relative z-10 mb-6">
                        <svg className="w-24 h-24 text-yellow-100/90 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-yellow-100/80 dark:focus:border-purple-500/60 focus:ring-2 focus:ring-yellow-100/20 dark:focus:ring-purple-500/20 transition-all duration-200"
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border-2 border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-yellow-100/20 dark:focus:ring-purple-500/20 focus:border-yellow-100/80 dark:focus:border-purple-500/60 transition-all duration-200 resize-y"
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-yellow-100/90 dark:bg-purple-600 hover:bg-yellow-50 dark:hover:bg-purple-700 text-gray-900 dark:text-white rounded-lg font-medium transition-all duration-200 border-2 border-yellow-100/80 dark:border-purple-700 hover:border-yellow-50 dark:hover:border-purple-800 shadow-lg hover:shadow-xl flex justify-center"
                  >
